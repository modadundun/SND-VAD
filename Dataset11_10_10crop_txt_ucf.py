    ...
    def __getitem__(self, index):
        if self.train:
            ...
            for a_i, n_i in zip(anomaly_indexs, normaly_indexs):
                ...
                categories = ["Abuse", "Arrest", "Arson", "Assault", "Burglary", "Explosion", "Fighting",
                              "RoadAccidents",
                ...
                for category in categories:
                    if category in anomaly_data_video_name:
                        ...
                        break
                if matched_category:
                    # npy_file_path = f'../features_txt_Clip/{matched_category}.npy'
                    npy_file_path = f'../clip_txt/txt_ucf_features/{matched_category}.npy'

                    anomaly_features_txt = np.load(npy_file_path)
                    anomaly_features_txt = torch.tensor(anomaly_features_txt)

                # normal_txt_path = f'../features_txt_Clip/Normal.npy'
                normal_txt_path = f'../clip_txt/txt_ucf_features/Normal.npy'
                ...
                # print(anomaly_features_txts.shape)
